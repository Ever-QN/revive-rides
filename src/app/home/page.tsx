      ...
      <div className="w-full pt-24">
        <ImagesSlider className="h-[50rem]" images={sliderImages}>
          ...
          >
            ...
            <Link className="px-4 py-2 border border-red-400 bg-red-700 text-white mx-auto text-center rounded-full relative mt-4 hover:scale-110 active:scale-125 transition-all duration-100" href="/book-appointment">
