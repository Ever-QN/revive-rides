    ...
    <div className="flex items-center justify-center h-screen p-4">
      <Card className="w-full max-w-md">
        <CardContent className="flex flex-col items-center justify-center p-8">
          ...
          <CardDescription className="mb-6">Your appointment as been booked. Once your appointment is confirmed, the status will change from pending to confirmed.</CardDescription>
